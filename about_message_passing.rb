...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # ANS: __send__ would be used when trying to avoid conflicts with other definitions of send
  end
  ...
  def test_respond_to_still_responds_to_other_methods
    catcher = AllMessageCatcher.new
    assert_equal true, catcher.respond_to?(:test)
  end
