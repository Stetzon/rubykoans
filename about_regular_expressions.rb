...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # Never, since it accounts for no matches
  end
  ...
  #
  # Why?
  # They can "swallow up" an entire string when searching for a match
  ...
  # Alternation is used for when needing to match more than one character
