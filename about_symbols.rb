...
class AboutSymbols < Neo::Koan
  ...
  #
  # Ans: Because when comparing the equality of two symbols, you're comparing object identity and not the content of the identifier that refers to this symbol
  # Thus we need to convert to a string before doing a comparison
  ...
  def test_symbols_do_not_have_string_methods
    symbol = :not_a_string
    assert_equal false, symbol.respond_to?(:each_char)  # `respond_to` returns true if obj has the given method
  ...
  # Ans: They stay in memory until the program exits. This makes them a memory hog if you misuse them.
end
